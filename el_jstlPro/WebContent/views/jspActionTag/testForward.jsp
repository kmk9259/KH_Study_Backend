...
<body>
	...
	<%--기존방식
		import="com.kh.el.model.vo.Member" 필요함
	 <%
		Member m = new Member();
		m.setName("김민경");
		m.setAge(25);
		m.setPhone("010-2969-8206");
		m.setEmail("kmk9259@naver.com");
	%>
	...
	<jsp:setProperty property="phone" name="m" value="010-8888-8888"/>
	<jsp:setProperty property="email" name="m" value="d@naver.com"/>
	
	이름 : <jsp:getProperty property="name" name="m"/><br>
	나이 : <jsp:getProperty property="age" name="m"/><br>
	번호: <jsp:getProperty property="phone" name="m"/><br>
