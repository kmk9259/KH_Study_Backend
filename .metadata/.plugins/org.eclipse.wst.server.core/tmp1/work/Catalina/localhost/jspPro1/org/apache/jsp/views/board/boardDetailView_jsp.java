 ...
 * Generated at: 2021-09-15 06:43:24 UTC
...
if(loginUser == null){
 ...
 if(loginUser != null){ 
      ...
      out.write("	<script type=\"text/javascript\">\r\n");
      out.write("		$(function(){\r\n");
      out.write("			selectReplyList();	//게시물을 들어왔을 때도 댓글 조회가 되야함으로 \r\n");
      out.write("			\r\n");
      out.write("			$(\"#addReply\").click(function(){\r\n");
      out.write("				var content = $(\"#replyContent\").val();\r\n");
      out.write("				//어느 게시물인지 알아야 그 게시물에 댓글을 달아야함\r\n");
      out.write("				var bId = ");
      out.print(b.getBoardNo());
      out.write(";\r\n");
      out.write("				\r\n");
