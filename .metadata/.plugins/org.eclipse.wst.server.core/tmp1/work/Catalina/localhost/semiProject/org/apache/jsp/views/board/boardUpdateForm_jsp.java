 ...
 * Generated at: 2021-09-13 09:04:16 UTC
...
session.removeAttribute("msg");
      ...
      out.write("                  <input type=\"text\" class=\"form-control\" id=\"name\" name=\"title\" value=\"");
      ...
      out.write("              <div class=\"form-group\">\r\n");
      out.write("                  \r\n");
      out.write("                  <textarea rows=\"15\" cols=\"150\" name=\"content\" class=\"form-control\" id=\"message\"  tabindex=\"4\" required>");
 ...
 System.out.print("jsp  첨부파일 있니?" + fileList); 
      ...
      out.write("\"  id=\"titleImg\"  width=\"200px\" height=\"180\">\r\n");
      out.write("              	<input type=\"hidden\" name=\"fno\" value='");
      out.print(fileList.get(0).getFileNo() );
      out.write("' >\r\n");
      out.write("             	<input type='hidden' name='originFile0' value='");
 ...
 System.out.print("화면에 담긴 파일 번호는? ?  "+fileList.get(3).getFileNo() ); 
      ...
      out.write("\"  id=\"contentImg1\"   width=\"200px\" height=\"180\">\r\n");
      out.write("             	<input type=\"hidden\" name=\"fno\" value='");
      out.print(fileList.get(1).getFileNo() );
      out.write("' >\r\n");
      out.write("             	<input type='hidden' name='originFile1' value='");
      out.print(fileList.get(1).getOriginName());
      out.write("'>\r\n");
      out.write("				<input type='hidden' name='originFileNo' value='");
      out.print(fileList.get(1).getFileNo());
      out.write("'>\r\n");
      ...
      out.write("\"  id=\"contentImg2\"   width=\"200px\" height=\"180\">\r\n");
      out.write("             	<input type=\"hidden\" name=\"fno\" value='");
      out.print(fileList.get(2).getFileNo() );
      out.write("' >\r\n");
      out.write("             	<input type='hidden' name='originFile2' value='");
      out.print(fileList.get(2).getOriginName());
      out.write("'>\r\n");
      out.write("				<input type='hidden' name='originFileNo' value='");
      out.print(fileList.get(2).getFileNo());
      out.write("'>\r\n");
      ...
      out.write("\"  id=\"contentImg3\"   width=\"200px\" height=\"180\">\r\n");
      out.write("             	<input type=\"hidden\" name=\"fno\" value='");
      out.print(fileList.get(3).getFileNo() );
      out.write("' >\r\n");
      out.write("             	<input type='hidden' name='originFile3' value='");
      out.print(fileList.get(3).getOriginName());
      out.write("'>\r\n");
      out.write("				<input type='hidden' name='originFileNo' value='");
      out.print(fileList.get(3).getFileNo());
      out.write("'>\r\n");
 ...
 System.out.print("화면에 담긴 파일 번호는? ?  "+fileList.get(3).getFileNo() ); 
      ...
      out.write("    \r\n");
      out.write("				<input type=\"file\" id=\"file1\" onchange=\"loadImg(this, 1);\">\r\n");
      out.write("				<input type=\"file\" id=\"file2\" onchange=\"loadImg(this, 2);\">\r\n");
      out.write("				<input type=\"file\" id=\"file3\" onchange=\"loadImg(this, 3);\">\r\n");
      out.write("				<input type=\"file\" id=\"file4\" onchange=\"loadImg(this, 4);\">\r\n");
      out.write("			    </div>\r\n");
      out.write("              \r\n");
      out.write("              </div>\r\n");
      out.write("              \r\n");
      ...
      out.write("             \r\n");
      out.write("             \r\n");
      out.write("             <input type=\"file\" name=\"upFile0\" value='");
      out.print(fileList.get(0).getFileNo());
      out.write("' >\r\n");
      ...
      out.print(fileList.get(2).getFileNo());
      out.write("'>\r\n");
      out.write("             <input type=\"file\" name=\"upFile3\" value='");
      out.print(fileList.get(3).getFileNo());
      out.write("'>\r\n");
      out.write("             \r\n");
      out.write("              \r\n");
      ...
      out.write("              \r\n");
      out.write("              \r\n");
      out.write("              <button type=\"submit\" class=\"site-btn\" onclick=\"checkValue()\">수정하기</button>\r\n");
      out.write("              \r\n");
      out.write("              </div>\r\n");
      out.write("              \r\n");
      out.write("          </form>\r\n");
