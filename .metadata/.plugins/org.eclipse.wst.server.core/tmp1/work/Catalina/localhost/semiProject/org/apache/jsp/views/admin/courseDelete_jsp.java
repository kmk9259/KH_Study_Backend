 ...
 * Generated at: 2021-09-21 18:45:57 UTC
...
public final class courseDelete_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ArrayList<Area> alist = (ArrayList<Area>)request.getAttribute("alist");
      ...
      out.write("<title>어디어디 - 관리자페이지(코스 조회)</title>\r\n");
...
session.removeAttribute("msg");
      ...
      out.print(contextPath);
      out.write("/views/admin/courseDelete.jsp\" >코스 삭제</a></li>\r\n");
      out.write("								\r\n");
      ...
      out.write("			\r\n");
      out.write("				<div class=\"section-title\">\r\n");
      out.write("	            	<h2 style=\"margin: 0px;\">코스 삭제</h2>\r\n");
      out.write("		        </div>\r\n");
      out.write("					<div>\r\n");
      out.write("						<select id=\"placeChoice\" name=\"placeChoice\"\r\n");
      out.write("							onchange=\"changeArea(this)\">\r\n");
...
for(Area a : alist) {
      ...
      out.write("				<div class=\"container\">\r\n");
      out.write("					<div class=\"row\" id=\"courseList\">\r\n");
      out.write("		                \r\n");
      out.write("		            </div>\r\n");
      out.write("		        </div>\r\n");
      out.write("			</section>\r\n");
      out.write("					\r\n");
      out.write("					\r\n");
      out.write("			</div><!-- admin-showpage nice-scroll -->\r\n");
      out.write("			<script>\r\n");
      out.write("			function changeArea(obj)\r\n");
      out.write("			{\r\n");
      out.write("				var placeChoice = document.getElementById('placeChoice');\r\n");
      out.write("				var aNo = placeChoice.options[placeChoice.selectedIndex].value;\r\n");
      out.write("				$(\"#courseList\").empty();\r\n");
      out.write("				$.ajax({\r\n");
      ...
      out.write("						var tmp=\"\";\r\n");
      out.write("						$.each(map[\"cArr\"], function(index, value) {\r\n");
      out.write("							var TitleImg =  getTitleImg(value.courseNo, value.areaNo)\r\n");
      out.write("							var src = \"");
      out.print( contextPath);
      out.write("/resources/place_upFiles/\"+TitleImg;\r\n");
      out.write("							\r\n");
      out.write("							switch(value.areaNo){\r\n");
      out.write("							case 1 :\r\n");
      out.write("								var areaName=\"홍대\";								\r\n");
      out.write("								break;\r\n");
      out.write("							case 2 :\r\n");
      out.write("								var areaName=\"강남\";\r\n");
      out.write("								break;							\r\n");
      out.write("							}\r\n");
      out.write("							switch(value.themeNo){\r\n");
      out.write("							case 1 :\r\n");
      out.write("								var themeName=\"연인과함께\";								\r\n");
      out.write("								break;\r\n");
      out.write("							case 2 :\r\n");
      out.write("								var themeName=\"가족과함께\";								\r\n");
      out.write("								break;\r\n");
      out.write("							case 3 :\r\n");
      out.write("								var themeName=\"친구와함께\";								\r\n");
      out.write("								break;\r\n");
      out.write("							}\r\n");
      out.write("							tmp +='<div class=\"col-lg-4 col-md-6\">'\r\n");
      out.write("	                    		+'<div class=\"blog__item\">'\r\n");
      out.write("	                    			+'<input type=\"hidden\" id=\"courseNo\" class=\"courseNo\" name=\"courseNo\" value=\"'+value.courseNo+'\">'\r\n");
      out.write("                        			+'<div class=\"blog__item__pic set-bg\" style=\"height:300px; background-image: url(' + src + '); \"></div>'\r\n");
      out.write("                        			+'<div class=\"listing__item__pic__tag\">NO. '+value.courseNo+'</div>'\r\n");
      out.write("                        			+'<div class=\"blog__item__text\">'\r\n");
      out.write("			                            +'<ul class=\"blog__item__tags\">'\r\n");
      out.write("			                                +'<li><i class=\"fa fa-tags\"></i>'+areaName+'</li>'\r\n");
      out.write("			                                +'<li>'+themeName+'</li>'\r\n");
      out.write("			                            +'</ul>'\r\n");
      out.write("			                            +'<h5><a href=\"#\">'+value.courseTitle+'</a></h5>'\r\n");
      out.write("		                            	+'<button class=\"btn site-btn\">삭제하기</button>'\r\n");
      out.write("				                    +'</div>'\r\n");
      out.write("				                    +'</div>'\r\n");
      out.write("                    			+'</div>'\r\n");
      out.write("           					+'</div>';\r\n");
      ...
      out.write("						})\r\n");
      out.write("						\r\n");
      out.write("						 $(\"#courseList\").html(tmp).trigger(\"create\");\r\n");
      out.write("						 $(function(){\r\n");
      out.write("								$(\".blog__item__pic\").click(function(){\r\n");
      out.write("									var parent = $(this).parents();  \r\n");
      out.write("									var cNo = parent.children(\"#courseNo\").val();\r\n");
      out.write("									\r\n");
      out.write("									location.href=\"");
      out.print(contextPath);
      out.write("/cplaceDetail.co?cNo=\"+cNo;\r\n");
      out.write("								});\r\n");
      out.write("							});\r\n");
      out.write("						 $(function(){\r\n");
      ...
      out.write("				})				\r\n");
      out.write("			}\r\n");
      out.write("			function getTitleImg(cNo, aNo)\r\n");
      out.write("			{\r\n");
      out.write("				var src =\"\";\r\n");
      out.write("				console.log(cNo, aNo);\r\n");
      out.write("				$.ajax({\r\n");
      out.write("					url : \"cList.co\",\r\n");
      out.write("					type : \"post\",\r\n");
      out.write("					data:{cNo : cNo, aNo: aNo},\r\n");
      out.write("					async:false,\r\n");
      out.write("					success:function(map){\r\n");
      out.write("						var tmp=\"\";\r\n");
      out.write("						$.each(map[\"tArr\"], function(index, value) {\r\n");
      out.write("							console.log(value);\r\n");
      out.write("							console.log(value.areaNo);\r\n");
      out.write("							src = value.titleImg;\r\n");
      out.write("						})\r\n");
      out.write("					}//success	\r\n");
      out.write("				})\r\n");
