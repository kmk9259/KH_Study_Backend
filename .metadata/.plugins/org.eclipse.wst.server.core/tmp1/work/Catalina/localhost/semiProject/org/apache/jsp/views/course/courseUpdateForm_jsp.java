 ...
 * Generated at: 2021-09-21 18:48:04 UTC
...
import semiProject.com.kh.theme.model.vo.*;
...
public final class courseUpdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/course/../common/menubar.jsp", Long.valueOf(1632206324817L));
    _jspx_dependants.put("/views/course/../common/footer.jsp", Long.valueOf(1632206324672L));
  }
  ...
  static {
    ...
    _jspx_imports_packages.add("semiProject.com.kh.theme.model.vo");
    ...
    _jspx_imports_classes.add("semiProject.com.kh.theme.model.vo.Theme");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	for(int i=0; i<tlist.size(); i++)	//0, 1,2
	{
      ...
      out.write("<title>어디어디 - 관리자페이지(코스 수정)</title>\r\n");
...
session.removeAttribute("msg");
      ...
      out.write("					<div class=\"section-title\">\r\n");
      out.write("			            <h2 style=\"margin: 0px;\">코스 수정</h2>\r\n");
      out.write("			        </div>\r\n");
      out.write("					<select id=\"placeChoice\" name=\"placeChoice\" >\r\n");
      out.write("							<option value=\"0\" selected>지역을 선택하세요</option>\r\n");
      out.write("							");
for(int i=0; i<alist.size(); i++) {
      ...
      out.write("										</div><br><br>\r\n");
      out.write("										<form action=\"update.co\" method=\"post\" id=\"updateForm\" onsubmit=\"return fieldCheck()\">\r\n");
      out.write("													<input type=\"hidden\" name=\"cNo\" value=\"");
      out.print(c.getCourseNo());
      out.write("\"> \r\n");
      out.write("													<input type=\"hidden\" name=\"aNo\" value=\"");
      out.print(c.getAreaNo());
      out.write("\">													\r\n");
      out.write("											코스이름: <input value=\"");
      out.print( c.getCourseTitle() );
      out.write("\" maxlength=\"100\"type=\"text\" required=\"required\" name=\"courseTitle\" placeholder=\"코스의이름을입력해주세요\" /><br>\r\n");
      out.write("											테마종류: 	");
for(int i=0; i<tlist.size(); i++) {
      out.write("\r\n");
      out.write("														<label><input type=\"radio\" name=\"themeNo\"  value=\"");
      out.print(tlist.get(i).getThemeNo() );
      out.write('"');
      out.write(' ');
      out.print(checked2[i] );
      out.write('>');
      out.write(' ');
      out.print(tlist.get(i).getThemeName() );
      out.write("</label>\r\n");
      out.write("													");
} 
      out.write("<br><br>\r\n");
      out.write("											<textarea id=\"textarea\" name=\"pNo\" rows=\"5\" cols=\"300\" style=\"resize: none;\"></textarea><br>\r\n");
      out.write("											<button id=\"courseAdd\"  class=\"nextBtn btn-ms\" type=\"submit\" style=\"margin-right: 1100px\">코스 수정</button>\r\n");
      out.write("										</form>\r\n");
      out.write("									</div>\r\n");
      out.write("				                </div>\r\n");
      out.write("				            </div>\r\n");
      ...
      out.write("					var cpnoSize = \"");
      out.print( cpnoSize);
      out.write("\";\r\n");
      out.write("					if(count >3){\r\n");
      out.write("						alert(\"일정은 최대 3개까지만 선택 할 수 있습니다.\");\r\n");
      out.write("						return false;\r\n");
      out.write("					}else if(count ==0){\r\n");
      out.write("						alert(\"코스에 등록할 일정을 선택해주세요\")\r\n");
      out.write("						return false;\r\n");
      out.write("					}else if(count <cpnoSize){\r\n");
      out.write("						alert(cpnoSize+\"개의 일정을 선택해주세요. 현재 일정의 개수는 \"+count+\"개 입니다.\");\r\n");
      out.write("						return false;\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("				$(function() {\r\n");
      out.write("					var areaNo = placeChoice.options[placeChoice.selectedIndex].value;\r\n");
      out.write("					if(areaNo !=null){\r\n");
      out.write("						$(\"#placeList\").empty();\r\n");
      out.write("						$.ajax({\r\n");
      out.write("							url : \"pList.co\",\r\n");
      out.write("							type : \"post\",\r\n");
      out.write("							data:{areaNo : areaNo},\r\n");
      ...
      out.write("								{\r\n");
      out.write("									var titleImg = list[i].titleImg;\r\n");
      out.write("									var src = \"");
      out.print( contextPath);
      out.write("/resources/place_upFiles/\"+titleImg;\r\n");
      out.write("									switch(list[i].categoryNo){\r\n");
      out.write("									case 1 :\r\n");
      out.write("										var categortName=\"먹기\";\r\n");
      out.write("										break;\r\n");
      out.write("									case 2 :\r\n");
      out.write("										var categortName=\"마시기\" \r\n");
      out.write("										break;\r\n");
      out.write("									case 3 :\r\n");
      out.write("										var categortName=\"놀기\"\r\n");
      out.write("										break;\r\n");
      out.write("									\r\n");
      out.write("									}\r\n");
      out.write("									value +=\r\n");
      ...
      out.write("											'<input type=\"hidden\" name=\"pNo\" id=\"placeNo\" value=\"'+list[i].placeNo+'\">'+\r\n");
      out.write("										    '<div class=\"listing__item__pic set-bg\" style=\"height:300px; background-image: url(' + src + '); \">'+\r\n");
      out.write("										        '<img src=\"resources/img/listing/list_icon-1.png\" alt=\"\">'+\r\n");
      out.write("										        '<div class=\"listing__item__pic__tag\">NO. '+list[i].placeNo+'</div>'+								        \r\n");
      out.write("										    '</div>'+\r\n");
      out.write("											'<div class=\"listing__item__text\">'+\r\n");
      out.write("											    '<div class=\"listing__item__text__inside\">'+\r\n");
      out.write("											        '<h5>'+list[i].placeTitle+'</h5>'+\r\n");
      out.write("											        '<p>'+list[i].description+'</p>'+\r\n");
      ...
      out.write("											            '</div>'+\r\n");
      out.write("											            '<h6>'+list[i].price+' 원</h6>'+\r\n");
      out.write("											            '</div>'+\r\n");
      out.write("											        '<ul>'+\r\n");
      out.write("											            '<li><span class=\"icon_pin_alt\"></span> '+list[i].address+'</li>'+\r\n");
      out.write("											            '<li><span class=\"icon_phone\"></span> '+list[i].placePhone+'</li>'+\r\n");
      out.write("											        '</ul></div>'+\r\n");
      ...
      out.write("											            '<span>'+categortName+'</span></div>'+\r\n");
      out.write("											        '<div class=\"listing__item__text__info__right\">Open Now</div>'+\r\n");
      out.write("											    '</div>'+\r\n");
      out.write("											    '<input type=\"checkbox\" id=\"check\" class=\"check\" name=\"check\" onclick=\"checkbox(this)\" value=\"'+list[i].placeNo+'\">선택 '+\r\n");
      out.write("											'</div></div></div>';	\r\n");
      out.write("											\r\n");
      out.write("								}//for\r\n");
      out.write("							 	$(\"#placeList\").html(value);\r\n");
      out.write("							 	\r\n");
      out.write("							}//success\r\n");
      out.write("						})\r\n");
      out.write("								\r\n");
      ...
      out.write("\r\n");
      out.write("								\r\n");
      out.write("				function checkbox(check)\r\n");
      out.write("				{				\r\n");
      out.write("					var placeNo = check.value;\r\n");
      out.write("					var result = document.getElementById(\"textarea\");\r\n");
      out.write("					if( check.checked==true )\r\n");
      out.write("					{\r\n");
      out.write("						if (result.value == \"\") \r\n");
      out.write("						{\r\n");
      out.write("							result.value = placeNo;\r\n");
      out.write("						} \r\n");
      out.write("						else \r\n");
      out.write("						{\r\n");
      out.write("							result.value += \",\" + placeNo;\r\n");
      ...
      out.write("					else \r\n");
      out.write("					{\r\n");
      out.write("						var resultArr = result.value.split(\",\");\r\n");
      out.write("						for (var i = 0; i < resultArr.length; i++) \r\n");
      out.write("						{\r\n");
      out.write("							if (resultArr[i] == placeNo) \r\n");
      out.write("							{\r\n");
      out.write("								resultArr.splice(i, 1);\r\n");
      out.write("								break;\r\n");
      out.write("							}\r\n");
      out.write("						}\r\n");
      out.write("						result.value = resultArr.join(\",\");\r\n");
      out.write("					}\r\n");
      out.write("				}\r\n");
      out.write("				\r\n");
      out.write("				</script>\r\n");
